...
global DEBUG nvertex inblossom unusedblossoms blossombase blossomparent blossomchilds blossomendps label labelend queue neighbend blossombestedges edges endpoint;
v = edges(k,1);
w = edges(k,2);
wt = edges(k,3);
